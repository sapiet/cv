...
--
-- Hôte : localhost
-- Généré le : mar. 08 fév. 2022 à 09:54
...
(261, 44, 'Self', 'Développeur web', '2019-02-13', NULL, 'Le document que vous êtes en train de lire est généré automatiquement à partir d\'une source d\'information centralisée\r\nDéveloppement d\'un builder de curriculum vitae statique permettant un rendu <a href=\"/\" title=\"CV en ligne\" target=\"_blank\">web</a> et <a href=\"/curriculum-vitae.pdf\" title=\"CV en pdf\" target=\"_blank\">pdf</a>\r\nStack: HTML5 / CSS3 / SCSS / Symfony 4 / HTML2PDF / Gulp / MySQL', 'Marcq-en-barœul');
...
INSERT INTO `recommendation` (`id`, `profile_id`, `date`, `firstname`, `company`, `message`, `picture`) VALUES
(1, 44, '2022-01-17 13:20:21', 'Sandra Vanhove', 'Ci-Oniya', 'Xavier QUIEVRE est un développer très à l\'écoute qui s’est investi avec un grand professionnalisme dans l’ensemble de ses missions qui lui ont été confié. Il est sérieux, minutieux, force de proposition, diplomate et pédagogue. Je vous recommande vivement ce profil et je referai appel à Xavier sans aucune hésitation pour nos projets à venir chez Ci-Oniya.', 'https://media-exp1.licdn.com/dms/image/C5603AQEvA0pp8-RLiw/profile-displayphoto-shrink_200_200/0/1565958064558?e=1648684800&v=beta&t=Yvwf9C4Ly4fXw6vwRC-kDZPjc7t7hVsMxq1YF4NeLM0'),
(2, 44, '2022-01-18 13:20:21', 'Bernard Pagoaga', 'Jooxter', 'Xavier est un développeur expérimenté, sérieux et très efficace ! Il est par ailleurs très agréable de travailler avec lui, je recommande ;)', 'https://avatars.githubusercontent.com/u/10684574?v=4');
...
(340, 44, 'PHP7', 75, 'hard', 'backend'),
(341, 44, 'Symfony 1/2/3/4/5', 70, 'hard', 'backend'),
...
(522, 44, 'Ci-Oniya', 'Mise en place de la boutique en ligne et développement d\'un outils d\'optimisation des découpes', 'ci-oniya.png', 'https://ci-oniya.com/', 1),
...
(531, 44, 'WebdealAuto mobile', 'Développement d\'un site mobile sous Symfony 2 pour la société WebdealAuto', 'webdealauto-mobile-main-menu.png', NULL, 10),
